...
class _ProfileBodyState extends State<ProfileBody> {
  ...
  Widget build(BuildContext context) {
    return  SingleChildScrollView(
      child:getProfiledata == null ? Center(child: CircularProgressIndicator(
        ...
        children: [
          ...
          Stack(children: [
            Container(
              ...
              child:profilePhoto==null || getProfiledata!.data!.picture == null? CircleAvatar(
                radius: 40,
                child: ClipOval(
                  child: Image.network(
                    'https://cubixsys.com/cubixsys-support/${getProfiledata!.data!.picture}',fit: BoxFit.fill,width: 150,
                  ),
                ),
              ): ClipRRect(
                  borderRadius: BorderRadius.circular(100),
                  child: Image.file(profilePhoto!,fit: BoxFit.fill,width: 150,))
            ),
            Positioned(
              top: 100,
                left: 90,
