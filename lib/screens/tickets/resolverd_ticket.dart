...
class ResolvedTicket extends StatelessWidget {
  const ResolvedTicket({Key? key}) : super(key: key);
  static String routeName = '/resolve_ticket';
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        toolbarHeight: 80,
        title: const Center(child: Text("Resolved Tickets")),
        backgroundColor: const Color(0xff376AA9),
        elevation: 0.0,
        centerTitle: true,
        leading: Builder(
      ...
      body:   Container(
        ...
        child: const ResolvedTicketBody(),
      ),
    );
  }
}
