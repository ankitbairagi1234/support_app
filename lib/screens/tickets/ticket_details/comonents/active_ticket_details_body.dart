...
class ActiveTicketDetailsBody extends StatefulWidget {
  const ActiveTicketDetailsBody({Key? key}) : super(key: key);

  @override
  State<ActiveTicketDetailsBody> createState() => _ProductBodyState();
}

class _ProductBodyState extends State<ActiveTicketDetailsBody> {
