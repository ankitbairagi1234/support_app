...
import 'components/active_task_details_body.dart';


class ActiveTaskDetails extends StatelessWidget {
  const ActiveTaskDetails({Key? key, }) : super(key: key);
  static String routeName = "/active_taskDetails";
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Active Task Details", style: TextStyle(fontWeight: FontWeight.w700,),),
        backgroundColor: const Color(0xff376AA9),
        elevation: 0,
      ...
      body:   Container(
          ...
          child: const ActiveTaskDetailsBody()
      ),
    );
  }
}
