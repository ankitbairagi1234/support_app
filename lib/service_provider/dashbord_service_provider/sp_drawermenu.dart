...
import '../payment/all_payments_card/payment_card.dart';
import 'dashboard.dart';

class SpDrawerMenu extends StatefulWidget {
  const SpDrawerMenu({Key? key}) : super(key: key);
  @override
  State<SpDrawerMenu> createState() => _DrawerMenuState();
}

class _DrawerMenuState extends State<SpDrawerMenu> {
  ...
  Widget build(BuildContext context) => Drawer(
    child: ListView(
      ...
      children:[
        ...
        getProfiledata == null || getProfiledata!.data!.name!.isEmpty &&getProfiledata!.data!.mobile!.isEmpty ?Center(child: CircularProgressIndicator(
          ...
          child: Row(
            children:  [
              ...
              Column(
                ...
                children:  [
                  Text("${getProfiledata!.data!.name}", style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xff376AA9),),),
                  Padding(
        ...
        ListTile(leading: const Icon(Icons.home,size: 35,color: Color(0xff376AA9),),title: const Text("Dashboard",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Color(0xff376AA9)),), onTap: () => { Navigator.pushNamed(context, SpDashboard.routeName), },),
        SizedBox(height: 15,),
        ...
        // const Divider(height: 2, thickness: 1, color: Colors.black12,),
        SizedBox(height: 15,),
        ListTile(leading: const Icon(Icons.payment,size: 35,),  title: const Text("Payment ",style: TextStyle(fontSize: 18),), onTap: () => { Navigator.pushNamed(context, RequestPayment.routeName), },),
        // const Divider(height: 2, thickness: 1, color: Colors.black12,),
        SizedBox(height: 15,),
