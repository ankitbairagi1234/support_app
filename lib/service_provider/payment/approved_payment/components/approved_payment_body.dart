...
class ApprovedPaymentBody extends StatefulWidget {
  const ApprovedPaymentBody({Key? key}) : super(key: key);

  @override
  State<ApprovedPaymentBody> createState() => _ProductBodyState();
}

class _ProductBodyState extends State<ApprovedPaymentBody> {
  ...
  Widget build(BuildContext context) {
    ...
    ),) :allPayment!.data!.isEmpty?Center(child:Text("No data to show",style: TextStyle(fontSize: 20),),) :
    ListView.builder(
