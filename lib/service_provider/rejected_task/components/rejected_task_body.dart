...
class RejectedTaskBody extends StatefulWidget {
  const RejectedTaskBody({Key? key}) : super(key: key);

  @override
  State<RejectedTaskBody> createState() => _ProductBodyState();
}

class _ProductBodyState extends State<RejectedTaskBody> {

  String? taskId;


  TotalTask? rejectTaskList;
  ...
  Widget build(BuildContext context) {
    ...
    return rejectTaskList == null ? const Center(child: CircularProgressIndicator(
      semanticsLabel: 'Circular progress indicator',
    ),) :rejectTaskList!.data!.isEmpty?const Center(child:Text("No data to show",style: TextStyle(fontSize: 20),),) :
    ListView.builder(
              ...
              Card(
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text("${rejectTaskList!.data![index].ticket}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                        ),
                        SizedBox(
                          ...
                          child:  ListTile(
                            title: Padding(
                              ...
                              child: Text("${rejectTaskList!.data![index].productName} ", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 20 ), ),
                            ),
                            subtitle: Padding(
                              padding: EdgeInsets.only(bottom: 8.0),
                              child: Text("${rejectTaskList!.data![index].city}\n${rejectTaskList!.data![index].state}", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15 ),),
                            ),
                          ),
                        ),
                    ...
                    InkWell(
                      onTap: (){
                        print('${rejectTaskList!.data![index].taskId}');
      ...
      }, itemCount: rejectTaskList?.data?.length,);
  }
}
