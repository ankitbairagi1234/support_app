...
class ResolvedTaskDetailsBody extends StatefulWidget {
  const ResolvedTaskDetailsBody({Key? key}) : super(key: key);

  @override
  State<ResolvedTaskDetailsBody> createState() => _ProductBodyState();
}

class _ProductBodyState extends State<ResolvedTaskDetailsBody> {
