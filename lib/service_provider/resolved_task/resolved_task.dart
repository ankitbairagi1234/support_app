...
class ResolvedTask extends StatelessWidget {
  const ResolvedTask({Key? key}) : super(key: key);
  static String routeName = "/resolve_task";
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Resolved Task", style: TextStyle(fontWeight: FontWeight.w700,),),
        backgroundColor: const Color(0xff376AA9),
        elevation: 0,
