...
import '../../../models/total_task_details_model.dart';
import '../../../utils/colour.dart';
import '../../dashbord_service_provider/dashboard.dart';

class TaskDetailsBody extends StatefulWidget {
  const TaskDetailsBody({Key? key}) : super(key: key);

  @override
  State<TaskDetailsBody> createState() => _ProductBodyState();
}

class _ProductBodyState extends State<TaskDetailsBody> {
  ...
  TotalTaskDetailsModel? getTotalTaskDetails;
  ...
  taskDetails() async {
    ...
    print("${userId}");
    var request = http.MultipartRequest('POST', Uri.parse('${ApiPath.baseUrl}taskDetails'));
    ...
    if (response.statusCode == 200) {
      ...
      final jsonResponse = TotalTaskDetailsModel.fromJson(json.decode(finalResponse));


      print("$jsonResponse");
      print("__task-details$finalResponse");
      setState(() {
        getTotalTaskDetails = jsonResponse;
      });
    }
    else {
 ...
 String?taskid;
  acceptTask() async {
    taskid = getTotalTaskDetails!.data!.taskId.toString();
  ...
  Widget build(BuildContext context) {
    ...
    return getTotalTaskDetails == null ? const Center(child: CircularProgressIndicator(
        ...
        child: Column(
          ...
          children: [
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Product Name :${getTotalTaskDetails!.data!.productName}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                Text("Product Id :${getTotalTaskDetails!.data!.productId}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),)
              ],
            ),
            SizedBox(height: 30,),
            Text("Product Image :",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
            SizedBox(height: 20,),
            Image.network("https://cubixsys.com/cubixsys-support/${getTotalTaskDetails!.data!.productImage}",),
            SizedBox(height: 30,),
            SizedBox(height: 30,),
            Text("Issue Image :",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
            SizedBox(height: 20,),
            Image.network("https://cubixsys.com/cubixsys-support/${getTotalTaskDetails!.data!.image}",),
            Text("Product Invoice :",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
            SizedBox(height: 20,),
            Image.network("https://cubixsys.com/cubixsys-support/${getTotalTaskDetails!.data!.productInvoice}",),
            SizedBox(height: 30,),
            Text("Warranty Card :",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
            SizedBox(height: 20,),
            Image.network("https://cubixsys.com/cubixsys-support/${getTotalTaskDetails!.data!.warrantyCard}",),
            SizedBox(height: 30,),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Purchase Date :${getTotalTaskDetails!.data!.purchasedDate}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                Text("Invoice Date :${getTotalTaskDetails!.data!.invoiceDate}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),)
              ],
            ),
            SizedBox(height: 20,),
            Text("Warranty Date :${getTotalTaskDetails!.data!.warrantyDate}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
            SizedBox(height: 20,),
            Text("Description :${getTotalTaskDetails!.data!.taskDescription}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
            SizedBox(height: 30,),
            // InkWell(
            //   onTap: (){
            //     sendOTP();
